...
$('#create-playlist').on('click', function(){
  ...
  $.ajax({
    ...
    success: function(data){
      ...
      //var spotifyLink = "https://spotify-back-project.herokuapp.com/spotify?artists=" + artistString
      window.location = "https://spotify-back-project.herokuapp.com/spotify?artists=" + artistString
